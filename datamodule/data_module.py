...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        # Optional: limit number of training items (e.g., for LoRA finetuning on small data)
        limit_n = getattr(self.cfg.data, "train_limit_n", None)
        if limit_n is not None and limit_n > 0 and hasattr(train_ds, "list"):
            train_ds.list = train_ds.list[:limit_n]
